...
class ActionButton extends Component {
            ...
            <View style={{ position: 'absolute', bottom: 0, right: 0, left: 0 }}>
                <View key="main-button" style={styles.toolbarContainer}>
                    {actions.map( (action, index) => (
                        <View key={index} style={styles.toolbarActionContainer}>
                            <IconToggle
                                key={index}
                                icon={action}
    ...
    renderMainButton = (styles, mainIconElement) => {
        ...
        return (
            <View key="main-button" style={styles.container}>
                <RippleFeedback
                    ...
                    delayPressIn={20}
                >
                    { mainIconElement ? mainIconElement : this.renderIconButton(styles, mainIcon)}
                </RippleFeedback>
            </View>
        );
    }
    ...
    renderButton = (styles, mainIconElement) => (
        <View style={{ position: 'absolute', bottom: 20, right: 20 }}>
            {this.renderMainButton(styles, mainIconElement)}
        </View>
    );
    render() {
        const { render } = this.state;
        ...
        return this.renderButton(styles, this.props.mainIconElement);
    }
}
